module SuperRuby
  class IntegerLiteralFollowedByDotTokenMatch
    include ActiveModel::Model
    attr_accessor :before_dot_text, :integer_literal_match

    def consume!(character, &block)
      if character.is_super_whitespace?
        IntegerLiteralFollowedByDotAndWhitespaceTokenMatch.new(before_dot_text: before_dot_text)
      elsif character.is_super_integer_literal?
        FloatLiteralTokenMatch.new(before_decimal_point_text: before_dot_text).consume! character, &block

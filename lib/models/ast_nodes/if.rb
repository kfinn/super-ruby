module AstNodes
  class If
    ...
    def evaluate(typing)
      if condition_ast_node.evaluate(typing.condition_typing)
        then_branch_ast_node.evaluate(typing.then_branch_typing)
      elsif else_branch_ast_node.present?
        else_branch_ast_node.evaluate(typing.else_branch_typing)
      else
